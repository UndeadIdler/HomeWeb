<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_edit4.aspx.cs" Inherits="JumboECMS.WebFile.Admin.category_edit4" %>
...
$(document).ready(function(){
	...
	$("#txtAliasPage").formValidator({empty:true,tipid:"tipAliasPage",onshow:"请输入链接地址",onfocus:"请输入链接地址",oncorrect:"OK"}).InputValidator({min:4,max:30,onerror:"请输入链接地址"});
