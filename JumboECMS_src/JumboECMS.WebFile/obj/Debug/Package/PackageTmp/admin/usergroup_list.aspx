<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="usergroup_list.aspx.cs" Inherits="JumboECMS.WebFile.Admin._usergroup_list" %>
...
function ajaxDelete(id){
	$.ajax({
		...
		dataType:	"json",
		data:		"id="+id,
		url:		"usergroup_ajax.aspx?oper=ajaxDelete&time="+(new Date().getTime()),
...
function ajaxUserGroupCount(){
	top.JumboECMS.Loading.show("正在统计...");
	$.ajax({
		type:		"get",
		dataType:	"json",
...
<div class="topnav"> <span class="preload1"></span><span class="preload2"></span>
	<ul id="topnavbar">
		<li class="topmenu"><a href="javascript:void(0);" onclick="top.JumboECMS.Popup.show('usergroup_edit.aspx',-1,-1,true)" id="operater2" class="top_link"><span>添加用户组</span></a> </li>
	</ul>
	<script>
	topnavbarStuHover();
        </script>
...
<tbody>
	...
	<tr>
		...
		<td align="center"><a>{$T.record.usertotal}</a></td>
