<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="module_down_edit.aspx.cs" Inherits="JumboECMS.WebFile.Admin._module_down_edit" %>
...
$(document).ready(function(){
	...
	$("#txtTitle").formValidator({tipid:"tipTitle",onshow:"请输入标题，单引号之类的将自动过滤",onfocus:"至少输入6个字符",oncorrect:"OK"}).InputValidator({min:6,onerror:"至少输入6个字符,请确认"})
		...
		url:		"module_down_ajax.aspx?oper=checkname&time="+(new Date().getTime()),
		datatype : "json",
		success : function(d){	
			if(d.result == "1")
				return true;
...
<form id="form1" runat="server" onsubmit="return CheckFormSubmit()">
	<table class="formtable mrg10T">
		...
		<tr>
			<th> 文件地址</th>
			<td><asp:TextBox ID="txtDownUrl" runat="server" Width="97%" CssClass="ipt"></asp:TextBox>
				<br />
		...
		<tr>
			<th> 文件上传 </th>
			<td><iframe id="frm_upload" src="attachment_default.aspx?module=<%=MainModule.Type %>" width="100%"
