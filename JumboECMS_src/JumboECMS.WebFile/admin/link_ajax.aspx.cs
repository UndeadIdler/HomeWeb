...
{
    public partial class _link_ajax : JumboECMS.UI.AdminCenter
    {
        ...
        private void ajaxGetList()
        {
            ...
            int countNum = 0;
            string sqlStr = "";
            string joinStr = "A.[TypeId]=B.Id";
            string whereStr1 = "1=1";
            string whereStr2 = "1=1";
            doh.Reset();
            doh.ConditionExpress = whereStr2;
            countNum = doh.Count("jcms_normal_link");
            sqlStr = JumboECMS.Utils.SqlHelp.GetSql0("A.*,B.Title as typename", "jcms_normal_link", "jcms_normal_linkclass", "id", PSize, page, "desc", joinStr, whereStr1, whereStr2);
            doh.Reset();
            doh.SqlCmd = sqlStr;
