...
namespace JumboECMS.Utils
{
    ...
    public static class DirFile
    {
        ...
        public static void SaveFile(string TxtStr, string tempDir, bool noBom)
        {
            try
            {
                CreateDir(GetFolderPath(tempDir, true));
        ...
        {
            return GetFolderPath(filePath, false);
        }
        /// <summary>
        /// 获得文件的目录路径
        /// </summary>
        ...
        public static string GetFolderPath(string filePath, bool isUrl)
        {
            if (isUrl)
        ...
        /// <param name="filePath"></param>
        /// <returns></returns>
        public static string GetFileName(string filePath, bool isUrl)
        {
            if (isUrl)
        ...
        {
            string _fileName = GetFileName(_fullPath);
            try
            {
