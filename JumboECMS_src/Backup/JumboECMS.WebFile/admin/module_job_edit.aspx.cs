...
{
    public partial class module_job_edit : JumboECMS.UI.AdminCenter
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            id = Str2Str(q("id"));
            if (id == "0")
                Admin_Load("job-add", "html", "job");
            else
                Admin_Load("job-edit", "html", "job");
            ...
            doh.Reset();
            JumboECMS.DBUtility.WebFormHandler wh = new JumboECMS.DBUtility.WebFormHandler(doh, "jcms_module_job", btnSave);
            wh.AddBind(txtTitle, "Title", true);
            wh.AddBind(txtSourceFrom, "SourceFrom", true);
            wh.AddBind(txtNeedNumber, "NeedNumber", true);
            wh.AddBind(txtWorkAddress, "WorkAddress", true);
        ...
        protected bool chkForm()
        {
            ...
            if (FCKeditor1.Value == "")
            {
                this.txtContentMsg.Text = "请填写岗位要求!";
                return false;
            }
            return true;
        }
