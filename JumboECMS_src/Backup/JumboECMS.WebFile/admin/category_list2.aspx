<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_list2.aspx.cs" Inherits="JumboECMS.WebFile.Admin.category_list2" %>
...
function ajaxList(currentpage)
{
	...
	$.ajax({
		...
		url:		"category_ajax.aspx?oper=ajaxGetList&lan=en",
...
<div class="topnav"> <span class="preload1"></span><span class="preload2"></span>
	<ul id="topnavbar">
		<li class="topmenu"><a href="javascript:void(0);" class="top_link"><span
			...
			<ul class="sub">
				<li><a href="javascript:void(0);" onclick="JumboECMS.Popup.show('category_edit1.aspx?id=0&lan=en',-1,-1,false)" title="包含子类，不可以直接在此分类上发布内容">父级栏目</a></li>
				<li><a href="javascript:void(0);" onclick="JumboECMS.Popup.show('category_edit2.aspx?id=0&lan=en',-1,-1,false)" title="不包含子类">终极栏目</a></li>
				<li><a href="javascript:void(0);" onclick="JumboECMS.Popup.show('category_edit3.aspx?id=0&lan=en',-1,-1,false)" title="">单页栏目</a></li>
				<li><a href="javascript:void(0);" onclick="JumboECMS.Popup.show('category_edit4.aspx?id=0&lan=en',-1,-1,false)" title="">外链栏目</a></li>
...
<tbody>
	...
	<tr>
		...
		<td align="center" class="oper">
			<a href="javascript:void(0);" onclick="JumboECMS.Popup.show('category_edit{$T.record.typeid}.aspx?id={$T.record.id}&lan=en',-1,-1,true)">修改</a>
