<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emailserver_list.aspx.cs" Inherits="JumboECMS.WebFile.Admin._emailserver_list" %>
...
function ajaxDelete(id){
	$.ajax({
		...
		dataType:	"json",
		data:		"id="+id,
		url:		"emailserver_ajax.aspx?oper=ajaxDelete&time="+(new Date().getTime()),
	...
	$.ajax({
		...
		success:	function(d){
			...
			case '0':
				...
				break;
			case '1':
				top.JumboECMS.Alert(d.returnval, "1", "ajaxList("+page+");");
				break;
			}
		}
	});
...
<div class="topnav"> <span class="preload1"></span><span class="preload2"></span>
	<ul id="topnavbar">
		<li class="topmenu"><a href="javascript:void(0);" onclick="top.JumboECMS.Popup.show('emailserver_edit.aspx?id=0',-1,-1,true)" class="top_link"><span>添加发件人信息</span></a> </li>
	</ul>
	<script>
	topnavbarStuHover();
        </script>
...
<tbody>
		...
		<tr>
			...
			<td align="center">
			    <a href="javascript:void(0);" onclick="top.JumboECMS.Popup.show('emailserver_edit.aspx?id={$T.record.id}',-1,-1,true)">编辑</a>
