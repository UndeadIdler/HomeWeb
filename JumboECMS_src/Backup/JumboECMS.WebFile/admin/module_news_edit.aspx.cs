...
{
    public partial class module_news_edit : JumboECMS.UI.AdminCenter
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            id = Str2Str(q("id"));
            if (id == "0")
                Admin_Load("news-add", "html", "news");
            else
                Admin_Load("news-edit", "html", "news");
            ...
            doh.Reset();
            JumboECMS.DBUtility.WebFormHandler wh = new JumboECMS.DBUtility.WebFormHandler(doh, "jcms_module_news", btnSave);
