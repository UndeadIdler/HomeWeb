...
namespace JumboECMS.Entity
{
    ...
    /// 职位实体列表
    /// </summary>
    public class Module_Jobs
    {
        public Module_Jobs()
        { }
        public List<Module_Job> DT2List(DataTable _dt)
        {
            if (_dt == null) return null;
            return JumboECMS.Utils.dtHelp.DT2List<Module_Job>(_dt);
        }
    }
    /// <summary>
    /// 职位-------表映射实体
    /// </summary>
    public class Module_Job
    {
        public Module_Job()
        { }
