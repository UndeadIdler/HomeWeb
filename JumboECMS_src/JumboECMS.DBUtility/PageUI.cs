...
namespace JumboECMS.DBUtility.UI
{
    /// <summary>
    ...
    public abstract class PageUI : System.Web.UI.Page
    {
        ...
        /// </summary>
        public JumboECMS.DBUtility.DbOperHandler doh;
        /// <summary>
        /// 待实现的连接数据库函数。
        /// </summary>
        ...
        public void ConnectDb(string serverName, string userName, string password, string dataBaseName)
        {
            ...
            doh = new JumboECMS.DBUtility.SqlDbOperHandler(sqlConn);
        }
        /// <summary>
        /// 连接到一个Access数据库。
        /// </summary>
        ...
        public void ConnectDb(string dataBase)
        {
            ...
            doh = new JumboECMS.DBUtility.OleDbOperHandler(oleConn);
        }
